	...
	<div class="content clearfix">
		...
		<form action="<?=set_url('login');?>" method="post">
			...
			<div class="login-fields">
				...
				<p>Silahkan isikan info untuk login ... </p>
				...
				<div class="field">
					...
					<input type="password" id="password" name="password" value="" placeholder="Password" class="login password-field" autofocus />
				</div> <!-- /password -->
